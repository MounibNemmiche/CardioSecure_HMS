...
const navLinks = [
    ...
    { name: 'Patients', href: '/staff/patients', icon: 'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z' },
    { name: 'Profile', href: '/staff/profile', icon: 'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z' },
]
</script>
        ...
        >
            <div class="flex items-center gap-2 px-5 py-4 border-b border-gray-100">
                ...
                <div>
                    ...
                    <p class="text-xs text-violet-700 font-medium">Staff</p>
                </div>
            </div>
