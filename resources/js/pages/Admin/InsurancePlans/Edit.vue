...
const props = defineProps<{ plan: InsurancePlan }>()
...
function submit() {
    form.put(`/admin/insurance-plans/${props.plan.id}`)
}
</script>

<template>
    <div>
        <h1 class="text-2xl font-bold text-gray-900 mb-1">Edit Insurance Plan</h1>
        <p class="text-sm text-gray-500 mb-6">Update plan details.</p>
