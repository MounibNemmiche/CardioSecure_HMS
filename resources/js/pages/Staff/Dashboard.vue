...
<template>
    <div>
        ...
        <p class="text-sm text-gray-500 mb-8">Staff management panel</p>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
            ...
            <StatCard label="This Week" :value="upcomingThisWeek" color="amber">
                <template #icon>
                    <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <StatCard label="Total Patients" :value="totalPatients" color="emerald">
                <template #icon>
                    <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div class="bg-white rounded-xl border border-gray-200 overflow-hidden">
                <table class="min-w-full text-sm">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        <tr v-for="appt in recentAppointments" :key="appt.id" class="hover:bg-gray-50 transition-colors duration-150">
                            ...
                            <td class="px-4 py-3 text-gray-600">{{ appt.doctor }}</td>
